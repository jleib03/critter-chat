  ...
  return (
    <div className="min-h-screen bg-[#FBF8F3]">
      ...
      <div className="flex justify-center space-x-4 pb-16">
        <a href="https://apps.apple.com/app/critter" target="_blank" rel="noopener noreferrer" className="inline-block">
        ...
        <a
          href="https://play.google.com/store/apps/details?id=com.critter"
          target="_blank"
