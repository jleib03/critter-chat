...
Now
let
's update the ImplementationStep to generate the correct embedded widget code with proper webhook configuration:

```tsx file="components/custom-agent/implementation-step.tsx"
