...
export default function ProfessionalLandingPage() {
  ...
  const loadProfessionalData = async (forceRefresh = false) => {
    ...
    try {
      ...
      const landingData = await loadProfessionalLandingData(uniqueUrl, forceRefresh)
      ...
      if (landingData) {
        ...
        setProfessionalData(getDefaultProfessionalData(uniqueUrl))
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        const config = await loadChatConfig(uniqueUrl)
                        ...
                        {group.services.map((service, index) => (
                          <div key={service.id} className="p-4 border-b border-gray-50 last:border-b-0">
                            <div className="flex justify-between items-start mb-2">
                              ...
                              {professionalData.show_prices && service.cost && (
