-- MAIN QUERY - Use this one to get the actual configuration data
-- Replace $1 with your professional_id (e.g., 'prof_123')
...
SELECT 
    jsonb_build_object(
        ...
        'config_data', jsonb_build_object(
            'professional_id', COALESCE(pb.professional_id, $1),
...
-- SEPARATE TEST QUERY - Only use this to check if data exists
-- SELECT 
